package com.example.anyeok.domain.article.controller;

import com.example.anyeok.domain.article.dto.ArticleDTO;
import com.example.anyeok.domain.article.dto.request.ArticleCreateRequest;
import com.example.anyeok.domain.article.dto.request.ArticleModifyRequest;
import com.example.anyeok.domain.article.dto.response.ArticleCreateResponse;
import com.example.anyeok.domain.article.dto.response.ArticleModifyResponse;
import com.example.anyeok.domain.article.dto.response.ArticleResponse;
import com.example.anyeok.domain.article.dto.response.ArticlesResponse;
import com.example.anyeok.domain.article.entity.Article;
import com.example.anyeok.domain.article.service.ArticleService;
